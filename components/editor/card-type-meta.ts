...
export const CARD_TYPES: CardTypeMeta[] = [
  { type: "cover", label: "封面", description: "首页，突出主题", icon: "🏷" },
  { type: "content", label: "正文", description: "标题 + 要点列表（可插图）", icon: "📄" },
  { type: "image", label: "图文", description: "大图 + 简短说明", icon: "🖼" },
  { type: "summary", label: "重点总结", description: "分条总结结论", icon: "📌" },
  { type: "tips", label: "小贴士", description: "多条实用提示", icon: "💡" },
  { type: "comparison", label: "对比参考", description: "两栏正反对照", icon: "⇄" },
  { type: "step", label: "操作步骤", description: "按顺序分步说明", icon: "🔢" },
  { type: "stats", label: "关键数据", description: "数值 + 标签网格", icon: "📊" },
  { type: "faq", label: "常见问答", description: "Q&A 对", icon: "❓" },
  { type: "checklist", label: "检查清单", description: "待办/必做项", icon: "☑" },
  { type: "timeline", label: "时间线", description: "按时间推进的节点", icon: "⌛" },
  { type: "quote", label: "金句", description: "突出一句引用", icon: "❝" },
  { type: "cta", label: "结尾页", description: "收束、引导讨论", icon: "✉" },
];
